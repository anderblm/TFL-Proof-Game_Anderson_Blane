# TFL-Proof-Game_Anderson_Blane
This is my game TFL proof and Soundness Proof game!


Play:
Level 1: Match each rule name with its correct form
Level 2: Identify which rule corresponds to each soundness proof
